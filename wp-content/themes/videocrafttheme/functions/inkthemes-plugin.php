...
function inkthemes_plugins() {
    /**
     * Array of plugin arrays. Required keys are name and slug.
     * If the source is NOT from the .org repo, then source is also required.
     */
    $inkplugin = get_stylesheet_directory() . '/functions/lib/plugin/';
    $plugins = array(
        // This is an example of how to include a plugin pre-packaged with a theme
        array(
            'name' => 'InkMember Pro', // The plugin name
            'slug' => 'inkmemberpro', // The plugin slug (typically the folder name)
            'source' => $inkplugin . 'inkmemberpro.zip', // The plugin source
...
add_action('tgmpa_register', 'inkthemes_plugins');
?>