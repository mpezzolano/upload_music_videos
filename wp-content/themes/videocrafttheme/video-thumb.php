...
if (!empty($vid)) {
    ...
    if (empty($host)) {
        ...
        if (strpos($urll, "dailymotion.com")) {
            ...
            inkthemes_get_image(90, 60, 'dpic', $dailymotion_pic_url);
        }
        if (strpos($urll, "metacafe.com")) {
            if (preg_match("/((http:\/\/)?(www\.)?metacafe\.com)(\/watch\/)(\d+)(.*)/i", $urll, $match)) {
                ...
                inkthemes_get_image(90, 60, 'mpic', $meta_pic_url);
            }
        }
        if (strpos($urll, "vimeo.com")) {
            ...
            inkthemes_get_image(90, 60, 'vpic', $vimeourl);
        }
        if (strpos($urll, "youtube.com")) {
            ...
            inkthemes_get_image(90, 60, 'ypic', $y_url);
        }
    }
}
if ($upload_image) {
